...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets/web/images/favicon.png" type="image/png">
    ...
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="assets/web/css/LineIcons.2.0.css">
        
    
    <!--====== Style CSS ======-->
    <!-- <link rel="stylesheet" href="assets/web/css/style.css"> -->
    <link rel="stylesheet" href="assets/web/css/tailwind.css">
...
<body>
  ...
  <![endif]-->    
    ...
    <header class="header-area">
                    ...
                    <div class="w-full">
                        <nav class="flex items-center justify-between navbar navbar-expand-lg">
                            <a class="mr-4 navbar-brand" href="index.html">
                                <img src="assets/web/images/logo.svg" alt="Logo">
                            </a>
                            ...
                            <div class="absolute left-0 z-20 hidden w-full px-5 py-3 duration-300 bg-white shadow lg:w-auto collapse navbar-collapse lg:block top-100 mt-full lg:static lg:bg-transparent lg:shadow-none" id="navbarOne">
                                <ul id="nav" class="items-center content-start mr-auto lg:justify-end navbar-nav lg:flex">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#student">Students</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div id="home" class="header-hero" style="background-image: url(assets/web/images/banner-bg.svg)">
            <div class="container">
                ...
                <div class="justify-center row">
                    <div class="w-full lg:w-2/3">
                        <div class="text-center header-hero-image wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                            <img src="assets/web/images/header-hero.png" alt="hero">
            ...
            <div class="justify-center row">
                <div class="w-full sm:w-2/3 lg:w-1/3">
                    <div class="single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="services-icon">
                            <img class="shape" src="assets/web/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assets/web/images/services-shape-1.svg" alt="shape">
                ...
                <div class="w-full sm:w-2/3 lg:w-1/3">
                    <div class="mt-8 text-center single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="services-icon">
                            <img class="shape" src="assets/web/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assets/web/images/services-shape-2.svg" alt="shape">
                ...
                <div class="w-full sm:w-2/3 lg:w-1/3">
                    <div class="mt-8 text-center single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="services-icon">
                            <img class="shape" src="assets/web/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assets/web/images/services-shape-3.svg" alt="shape">
            ...
            <div class="row">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="mx-4 mt-12 text-center about-image wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets/web/images/about1.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="assets/web/images/about-shape-1.svg" alt="shape">
        </div>
    </section>
    ...
    <section class="relative pt-20 about-area">
        <div class="about-shape-2">
            <img src="assets/web/images/about-shape-2.svg" alt="shape">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="w-full lg:w-1/2 lg:order-first">
                    <div class="mx-4 mt-12 text-center about-image wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets/web/images/about2.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section class="relative pt-20 about-area">
        <div class="container">
            <div class="row">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="mx-4 mt-12 text-center about-image wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets/web/images/about3.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="w-full lg:w-1/2">
                    <div class="relative pb-8 mt-12 video-content wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img class="absolute bottom-0 left-0 -ml-8 dots" src="assets/web/images/dots.svg" alt="dots">
                        <div class="relative mr-6 rounded-lg shadow-md video-wrapper">
                            <div class="video-image">
                                <img src="assets/web/images/video.png" alt="video">
                            </div>
                    ...
                    <div class="pl-0 mt-12 counter-wrapper lg:pl-16 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="counter-content">
                            <div class="mb-8 section-title">
                                <div class="line"></div>
                                <h3 class="title">Why should you<span> join our institute?</span></h3>
                            </div> <!-- section title -->
                        ...
                        <div class="row no-gutters">
                            <div class="flex items-center justify-center single-counter counter-color-1">
                                <div class="text-center counter-items">
                                    <span class="text-2xl font-bold text-white"><span class="counter">{{$students->count()}}</span></span>
                                    <p class="text-white">Students</p>
                                </div>
                            </div> <!-- single counter -->
                            <div class="flex items-center justify-center single-counter counter-color-2">
                                <div class="text-center counter-items">
                                    <span class="text-2xl font-bold text-white"><span class="counter">500</span></span>
                            ...
                            <div class="flex items-center justify-center single-counter counter-color-3">
                                <div class="text-center counter-items">
                                    ...
                                    <p class="text-white">Student Rating</p>
                                </div>
                            </div> <!-- single counter -->
                        </div> <!-- row -->
                    </div> <!-- counter wrapper -->
            ...
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-8 text-center section-title">
                        <div class="m-auto line"></div>
                        <h3 class="title"><span>Meet Our</span> Instructors Team</h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="justify-center row">
                ...
                <div class="w-full sm:w-2/3 lg:w-1/3">
                    <div class="mt-8 text-center single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="relative team-image">
                            <img class="w-full" src="{{$instructor->avatar->url}}" alt="Team">
                        ...
                        <div class="p-8">
                            <h5 class="mb-1 text-xl font-bold text-gray-900">{{$instructor->name}}</h5>
    ...
    <!--====== TEAM PART ENDS ======-->
        ...
        <!--====== STUDENT PART PART START ======-->
    
        <section id="student" class="testimonial-area pt-120">
            <div class="container">
                <div class="justify-center row">
                    <div class="w-full lg:w-2/3">
                        <div class="pb-10 text-center section-title">
                            <div class="m-auto line"></div>
                            <h3 class="title">Our Students<span> their Current Positions</span></h3>
                        </div> <!-- section title -->
                    </div>
                </div> <!-- row -->
                <div class="row testimonial-active wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.8s">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mt-8 text-center single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                            <div class="relative team-image">
                                <img class="w-full" src="{{$student->avatar->url}}" alt="Team">
                                <div class="team-social">
                                    <ul>
                                        <li><a href="javascript:void(0)"><i class="lni lni-facebook-filled"></i></a></li>
                                        <li><a href="javascript:void(0)"><i class="lni lni-twitter-filled"></i></a></li>
                            ...
                            <div class="p-8">
                                <h5 class="mb-1 text-xl font-bold text-gray-900">{{$student->name}}</h5>
                                <p>Education : {{$student->education}}</p>
                                <p>Profession : {{$student->occupation}}</p>
                            </div>
                        </div> <!-- single team -->
        ...
        <div class="container">
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-10 text-center section-title">
                        <div class="m-auto line"></div>
                        <h3 class="title">Students sharing<span> their experience</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row testimonial-active wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.8s">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="flex items-center testimonial-author">
                            <div class="relative author-image">
                                <img class="shape" src="assets/web/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assets/web/images/author-1.png" alt="author">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="flex items-center testimonial-author">
                            <div class="relative author-image">
                                <img class="shape" src="assets/web/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assets/web/images/author-2.png" alt="author">
                            </div>
                            <div class="author-content media-body">
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="flex items-center testimonial-author">
                            <div class="relative author-image">
                                <img class="shape" src="assets/web/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assets/web/images/author-3.png" alt="author">
                            </div>
                            <div class="author-content media-body">
            ...
            <div class="justify-center row">
                <div class="w-full md:w-2/3 lg:w-1/3">
                    <div class="mx-4 mt-10 single-blog wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="mb-5 overflow-hidden blog-image rounded-xl">
                            <img class="w-full" src="assets/web/images/blog-1.jpg" alt="blog">
                        </div>
                ...
                <div class="w-full md:w-2/3 lg:w-1/3">
                    <div class="mx-4 mt-10 single-blog wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="mb-5 overflow-hidden blog-image rounded-xl">
                            <img class="w-full" src="assets/web/images/blog-2.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="flex mb-5 meta">
                                <li>Posted By: <a href="javascript:void(0)">Admin</a></li>
                ...
                <div class="w-full md:w-2/3 lg:w-1/3">
                    <div class="mx-4 mt-10 single-blog wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="mb-5 overflow-hidden blog-image rounded-xl">
                            <img class="w-full" src="assets/web/images/blog-3.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="flex mb-5 meta">
                                <li>Posted By: <a href="javascript:void(0)">Admin</a></li>
    ...
    <footer id="footer" class="relative z-10 footer-area pt-120">
        <div class="footer-bg" style="background-image: url(assets/web/images/footer-bg.svg);"></div>
        <div class="container">
                    ...
                    <div class="w-4/5 md:w-3/5 lg:w-2/6">
                        <div class="mt-12 footer-about wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a class="inline-block mb-8 logo" href="index.html">
                                <img src="assets/web/images/logo.svg" alt="logo" class="w-40">
                            </a>
...
-->
    ...
    <script src="assets/web/js/scrolling-nav.js"></script>
    
    <!--====== wow js ======-->
    <script src="assets/web/js/wow.min.js"></script>
    
    <!--====== Particles js ======-->
    <script src="assets/web/js/particles.min.js"></script>

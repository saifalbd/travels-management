...
<body class="min-h-screen bg-gray-50 dark:bg-gray-900 dark">
    ...
    aria-label="Sidebar" id="sidebar-multi-level-sidebar">
      ...
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{route('ins.course.index')}}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <x-icon.course class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></x-icon.course>
                    <span class="ml-3">Course Info</span>
                </a>
            </li>

            <li>
                <a href="{{route('ins.batch.index')}}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <x-icon.batch class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900
                    dark:group-hover:text-white"></x-icon.batch>
                    <span class="ml-3">Batch Info</span>
                </a>
            </li>
            ...
            <li>
                ...
                <ul id="student" class="hidden py-2 space-y-1 dropdown">
                   
                    <li>
                        <a href="{{route('pendingStudent.index')}}"> Pending Admission   </a>
                    </li>
                    <li>
                        <a href="{{route('ins.student.index')}}"> Current Students </a>
                    </li>
                    <li>
                        <a href="{{route('ins.student.index',['graduate'=>1])}}"> Graduate Student  </a>
                    </li>
    ...
    <header class="sm:ml-64 bg-yellow-100">
                  ...
                  dark:border-gray-700 flex items-center">
                   ...
                   border-gray-300 rounded-full h-7 hover:bg-blue-600 hover:text-white dark:text-white"
                      ...
                      ring-gray-300 dark:ring-gray-500"
                                ...
                                <span class="ml-2">{{ auth('ins')->user()->name }}</span>
        ...
        @auth
            ...
            <form action="{{ route('ins.logout') }}" method="POST" id="logoutForm">
                @csrf
